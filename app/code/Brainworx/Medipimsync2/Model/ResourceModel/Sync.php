<?php
namespace Brainworx\Medipimsync2\Model\ResourceModel;

/**
 * Medipimsync2 sync mysql resource
 */
class Sync extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('brainworx_medipimsync2_sync', 'sync_id');
    }
    ...
    {
    	if(strpos($object->getData('entity'), 'cat')  !== false || strpos($object->getData('entity'), 'prod') !== false )
    		return true;
    	else 
    		return false;
