<?php namespace brainworx\medipimsync\Model;

use brainworx\medipimsync\Api\Data\SyncInterface;
...
class Sync  extends \Magento\Framework\Model\AbstractModel implements SyncInterface, IdentityInterface
{
     ...
     * CMS page cache tag
     */
    const CACHE_TAG = 'medipimsync_Sync';

    /**
     * @var string
     */
    protected $_cacheTag = 'medipimsync_Sync';
     ...
     * @var string
     */
    protected $_eventPrefix = 'medipimsync_Sync';
    ...
    {
        $this->_init('brainworx\medipimsync\Model\ResourceModel\Sync');
    }
