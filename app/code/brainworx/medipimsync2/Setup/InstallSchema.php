...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        //DB name to be set in etc/adminhtml/di.xml + model/resourcemodel/sync.php
            ->newTable($installer->getTable('brainworx_medipimsync2_sync'))
            ->addColumn(
        	...
        	->addColumn('qty_insrt', Table::TYPE_INTEGER, null,
        			['nullable' => false, 'default' => '0'], 'Inserted quantity')
